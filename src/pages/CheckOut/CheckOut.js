      ...
      <div className="row">
        ...
        <div className="col-md-5 col-lg-4 col-xl-4 offset-lg-1 offset-xl-2">
          <div className="p-3">
            ...
            <div className="d-flex justify-content-between mt-2">
              <span>Tax(10%)</span> <span>+ ${item?.price * .1}</span>
            </div>
            <hr />
            <div className="d-flex justify-content-between mt-2">
            ...
            <hr />
            <div className="d-flex justify-content-between mt-2">
              <span>Total </span> <span className="text-success">${item?.price + item?.price * .1 + (item?.price - 50)}</span>
            </div>
            <button className="btn btn-primary my-3">Proced To CheckOut</button>
          </div>
        </div>
      </div>
    </div>
